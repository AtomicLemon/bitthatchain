...
//! These need to be macros, as clientversion.cpp's and bithatchain*-res.rc's voodoo requires it
...
/**
 * bithatchaind-res.rc includes this file, but it cannot cope with real c++ code.
