    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XBCH-light"), QVariant("light"));
    ui->theme->addItem(QString("XBCH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XBCH-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("XBCH-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("XBCH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XBCH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XBCH-traditional"), QVariant("trad"));
