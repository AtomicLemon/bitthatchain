    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bithatchain-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the bithatchain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XBCH, 0.1 XBCH, 1 XBCH and 10 XBCH -- sort of like the paper money you use every day.</li> \
