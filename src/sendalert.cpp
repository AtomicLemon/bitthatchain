...
2. run bithatchaind with -printalert or -sendalert like this:
   /path/to/bithatchaind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bithatchain.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/bithatchain Core:0.12.0.58/"));
