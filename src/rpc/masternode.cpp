...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print bithatchain address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bithatchain",               "masternode",             &masternode,             true,  {} },
    { "bithatchain",               "masternodelist",         &masternodelist,         true,  {} },
    { "bithatchain",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bithatchain",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bithatchain",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bithatchain",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
