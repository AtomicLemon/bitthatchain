...
This mechanism has been integrated into Bitcore-Node-bithatchain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bithatchainpay/insight-api-bithatchain#web-socket-api](https://github.com/bithatchainpay/insight-api-bithatchain#web-socket-api)
* API: [https://github.com/bithatchainpay/insight-api-bithatchain#instantsend-transactions](https://github.com/bithatchainpay/insight-api-bithatchain#instantsend-transactions)
...
By default, the bithatchain Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the bithatchain Core daemon:
